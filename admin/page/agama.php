 <ol class='breadcrumb'>
  ...
  $("body").on("click", ".hapus", function(e) {
                ...
                $(".agama_id").html($(DbNumberID).html());
                $('.dialog-hapus').modal('toggle');
                $("#konf").attr("href","hapusagama.php?agama_id="+$(DbNumberID).html());
            });
    ...
    $("body").on("click", ".edit", function(e) {
                ...
                var agama_id = $(kelas1).html();
                var keterangan = $(kelas2).html();
                $("#agama_id").val(agama_id);
                $("#keterangan").val(keterangan);
                $("#agama_id").attr("readonly","true");
                $('.edit-dialog').modal('toggle');
            });
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            Apakah anda ingn menghapus data dengan kode agama =  <span class='agama_id'></span>?
        </div>
      ...
      <div class="modal-body">
        ...
        <table class="table table-striped" width="100%">
            <!-- <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="agama_id" name="agama_id" placeholder="Kode" class="form-control" type="hidden" ></td>
            </tr> --><tr>
                <th width="25%">Nama agama</th>
                <td width="1%"> : </td>
                <td> <input id="keterangan" name="keterangan" placeholder="Nama" class="form-control" type="text" required ></td>
            </tr>
        </table>
...
<table class="table table-striped">
    ...
    <?php
        ...
        $exec=mysql_query("select * from app_agama ");
            ...
            $exec=mysql_query("select * from app_agama where agama_id like '%".$data."%' or keterangan like '%".$data."%'");
        }
