...
include "classes/class.phpmailer.php";
                ...
                if(isset($_POST['nama'])){
                               ...
                               if (mysql_num_rows($cek) > 0){
                                   echo "<script>alert('email telah terdaftar !!'); location.href='pendaftaran.php';</script>";
                               }elseif(mysql_num_rows($ceknomor) > 0){
                                   echo "<script>alert('nomor telah terdaftar !!'); location.href='pendaftaran.php';</script>";
                               }
                               else {
                                $simpan = mysql_query("insert into regist values('','$fixnama','$password','$fixemail','$nomor','$prodi1','$prodi2','$informasi','$provinsi','$kota','$statusdaftar','$usia','$tahun','$id_sks','Y','$angkatan1','$angkatan2','$ip','$nim')");
    ...
    if($mail->Send()) echo "Message has been sent";
							    ...
							    if ($simpan){
                                header("location:$url/calonmahasiswa/login.php");
                            }else{
                            	echo "Gagal Simpan";
                            }
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<!--<a href="daftar-kip.php"><span class="fa fa-pencil"></span> Pendaftaran KIP</a>-->
					</li>
    ...
    <div class="row">
					...
					<div class="col-md-12">
						<div class="grey-box-icon b4">  
							 <h4 class="modal-title" id="myModalLabel">Registrasi Calon Mahasiswa UNDARIS</h4>
        ...
        <table class="table " width="100%">
          ...
          <tr>
            ...
            <td width="1%"> : </td>
              ...
              <?php
                $exec=mysql_query("select * from student_angkatan where aktif='y'");
                while($hasil=mysql_fetch_array($exec))
                  echo "<option value='$hasil[0]'>$hasil[1]</option>";
              ?>
            </select>
            *) Untuk S2 Magister silahkan pilih reguler</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <tr>
                ...
                if($ref){
                ?>
                <th width="25%">Kode Refferal</th>
                <td width="1%"> : </td>
                <td> <input id="nim" name="nim" placeholder="Kode Refferal" class="form-control" type="text" value="<?= $ref ?>" readonly><br>*) Kode refferal adalah kode personal(NIK KTP untuk orang luar undaris ,NIM mahasiswa aktif/alumni) yang mengajak anda mendaftar di Undaris. Jika tidak ada silahkan dikosongkan.</td>
                <?php
                }else{
                ?>
                 <th width="25%">Kode Refferal</th>
                <td width="1%"> : </td>
                <td> <input id="nim" name="nim" placeholder="Kode Refferal" class="form-control" type="text"><br>*) Kode refferal adalah kode personal(NIK KTP untuk orang luar undaris ,NIM mahasiswa aktif/alumni) yang mengajak anda mendaftar di Undaris. Jika tidak ada silahkan dikosongkan.</td>
                <?php
                }
                ?>
            </tr>
            <input type="hidden" name="statusdaftar" id="statusdaftar" value="Tahap Seleksi">
            <input type="hidden" name="tahun" id="tahun" value="2022">
        </table>
