...
//   include "../koneksi.php";
  ...
  $username = $_GET['email'];
        ...
        if($cekrow > 0){
         ...
         $bayar = mysql_query("INSERT INTO proses_transaksi (id,email,brivaNo,custCode,amount,keterangan,expiredDate,tanggal_bayar,status,kode_bayar) VALUES ('', '$username', '12775', '0', '0', '0', '0000-00-00 00:00:00', '0', 'Y', '01')");
         if($bayar){
             echo "<script>alert('Berhasil Disimpan !!'); location.href='index.php?p=status';</script>";
            }else{
                echo "<script>alert('Gagal Disimpan !!'); location.href='index.php?p=daftar-beasiswa';</script>";
            }
        }else{
