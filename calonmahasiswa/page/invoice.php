...
?>
    ...
    <span>*note : ulangi klik print jika tidak berbentuk gambar.</span>
<div id="cetak">
    ...
    <div class="ui segment">
      ...
      <table class="ui collapsing table celled selectable teal">
        <tbody>
          ...
          <tr>
            <td><div class="ui ribbon label teal">Kode Bank</div></td>
            <td>002</td>
          </tr>
          <tr>
      ...
      <h2 class="ui header dividing">Bayar Melalui BRI</h2>
          ...
          <div class="content">
            ...
            <div class="description">
              ...
              <div class="ui ordered list">
                ...
                <div class="item">Masukkan <div class="ui label">Nomor Virtual Account</div>, misal. <div class="ui label">12775XXXXXXXXXXX</div></div>
