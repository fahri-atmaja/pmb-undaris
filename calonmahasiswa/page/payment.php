        ...
        <div class="col-md-6">
           ...
           <div class="table-responsive">
            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                <tr>
                   <td>Jenis Bayar</td><td>:</td><td>Pembayaran Biaya Pendaftaran</td>
                </tr>
            ...
            <input type="hidden" name="custCode" value="<?= substr($status['nomor'],0,8); ?>04" readonly>
            <input type="hidden" name="amount" value="<?php
        			    ...
        			    ?>" readonly>
            <input type="hidden" name="keterangan" value="Pembayaran Biaya Pendaftaran" readonly>
            ...
            <input type="hidden" name="kode_bayar" value="04" readonly>
            <button type="submit" name="submit" class="btn btn-primary">Proses</button>
           </div>
           </form>
           <span><b>PENTING!!</b> <br>Setelah menekan tombol "Proses" diwajibkan untuk segera membayar tagihan diatas dihari yang sama.</span>
        </div>
    </div>
</div>
<?php
...
exit();
        	...
        	if ($queque) {
        		echo "<script>alert('Proses Berhasil !!'); location.href='index.php?p=statusbayar';</script>";
        	} else {
