                                	...
                                	?>
                                		<tr>
                                			...
                                			<td>
                                				...
                                				echo '<a href="?p=statuspayment&id='.$fill[custCode].'"><button class="btn btn-success">CEK INVOICE</button></a>';
                                				
                                				}else{
                                				    echo '<a href="?p=payment-regist&id='.$field[id_tagihan].'"><button class="btn btn-primary">PROSES</button></a>';
                                				}
                            ...
                            echo "Koreksi data anda dibawah ini dengan sebenar-benarnya :
                                <form action='https://siakad.undaris.ac.id/pendaftaran.php' method='POST' target='_BLANK'>
                                    <table class='table table-bordered' border='0px'>
                                            <tr>
                                                <td>NIK</td><td>:</td><td><input type='text' class='form-control' name='nik' value='$array[nik]' require></td>
                                            </tr>
                                            <tr>
                                                <td>NISN *wajib ada dan benar</td><td>:</td><td><input type='text' class='form-control' name='nisn' value='$array[nisn]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Nama Lengkap</td><td>:</td><td><input type='text' class='form-control' name='nama' value='$array[nama]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Tempat Lahir</td><td>:</td><td><input type='text' class='form-control' name='tpt_lahir' value='$array[tpt_lahir]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal Lahir</td><td>:</td><td><input type='text' class='form-control' name='tgl_lahir' value='$array[tgl_lahir]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td><td>:</td><td><input type='text' class='form-control' name='email' value='$array[email]' require readonly></td>
                                            </tr>
                                            <tr>
                                                <td>Alamat</td><td>:</td><td><input type='text' class='form-control' name='alamat' value='$array[alamat]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Asal Sekolah atau Kampus</td><td>:</td><td><input type='text' class='form-control' name='asal_sekolah' value='$array[asal_sekolah]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Nama Ayah</td><td>:</td><td><input type='text' class='form-control' name='nmayah' value='$array[nmayah]' require></td>
                                            </tr>
                                            <tr>
                                                <td>Nama Ibu</td><td>:</td><td><input type='text' class='form-control' name='nmibu' value='$array[nmibu]' require></td>
                                            </tr>
                                            <tr>
                                                <td>No WA</td><td>:</td><td><input type='text' class='form-control' name='nohp' value='$array[nohp]' require></td>
                                            </tr>
                                    </table>
                                    <div class='form-group'>
                                    ...
                                    $tag = explode(",", $tags);
                                        ...
                                        <tr>
                                            ...
                                            <select class='form-control' name='id_kelas' value='' require>";
                                    foreach($tag as $t):
                                        $result = mysql_query("SELECT * FROM akademik_kelas WHERE id_kelas='$t'");
                                        $row = mysql_fetch_array($result);
                                        echo "
                                            <option class='form-control' name='id_kelas' value='$t'>$row[keterangan]</option>";
                                    endforeach;
                                    echo"
                                        <tr>
                                            <td>Ikut ospek tahun ini?</td><td>:</td><td>
                                            <select class='form-control' name='ospek' value='' require>
                                            <option class='form-control' name='ospek' value='1'>Ya</option>
                                            <option class='form-control' name='ospek' value='0'>Tahun Depan</option>
                                            </select></td>
                                        </tr>
                                        <tr>
                                            <td>Pilih ukuran jas almamater</td><td>:</td><td>
                                            <select class='form-control' name='size' value='' require>
                                            ...
                                            <option class='form-control' name='size' value='XXXL'>XXXL</option>
                                            </select></td>
                                        </tr>
                                        </table>
                                    </div>
                                        ...
                                        <button class='btn btn-primary' type='submit' name='submit'>PROSES DATA</button>
                                </form>";
                        ?>
                    </div>
                </div>
