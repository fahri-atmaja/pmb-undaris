...
<body>
<h4 class="modal-title" id="myModalLabel">Upload Berkas Beasiswa Hafidz</h4>
      ...
      <div class="modal-body">
        ...
        <table class="table " width="100%">
            <tr>
                ...
                <input type="hidden" name="jenis" value="hafidz">
            </tr>           
        </table>
        <h5>PERHATIAN! UPLOAD JADIKAN 1 FILE DENGAN FORMAT .PDF DENGAN UKURAN FILE KURANG DARI 2MB<br>
        *) SERTIFIKAT SYAHADAH, HAFAL DIATAS 20 JUZ ATAU 30 JUZ<br>
        <hr>
