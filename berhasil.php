    ...
    <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="grey-box-icon b4">  
                            <h4>SELAMAT</h4>
                            <p>ANDA TELAH BERHASIL MENDAFTAR SILAHKAN CEK EMAIL UNTUK KODE LOGIN.<BR>SILAHKAN LOGIN UNTUK INFO ADMINISTRASI DAN UJIAN SELEKSI LALU MENUNGGU PENGUMUMAN </p>
                            <p><a target="_BLANK" href="https://www.gmail.com"><em><i class='fa fa-envelope'></i> GMAIL→</em></a> 
                                <a target="_BLANK" href="https://www.yahoo.com"><em><i class='fa fa-envelope'></i> YAHOO→</em></a></p>
