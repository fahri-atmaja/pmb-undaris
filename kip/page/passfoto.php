                ...
                if(isset($_POST['submit'])){
                            ...
                            if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                                if($ukuran < 347000){          
                                    ...
                                    $query = mysql_query("UPDATE pendaftar_kip SET foto='$nama' WHERE email='$kodedaftar'");
                                    if($query){
...
<?php 
      ...
      <div class="modal-body">
        ...
        <a href="https://pmb.undaris.ac.id/kip/index.php?p=pendaftaran"><button type="button" class="btn btn-primary"><span class='fa fa-print'></span> Cetak KTM Sementara</button></a>
