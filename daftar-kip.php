<?php
// echo "<script>alert('PENDAFTARAN KIP DITUTUP !!'); location.href='$url/index-maintenance.php';</script>";
include "koneksi.php";
include "classes/class.phpmailer.php";
                if(isset($_POST['nama'])){
                                ...
                                $prodi3 		=addslashes($_POST['prodi3']);
                                $prodi4 		=addslashes($_POST['prodi4']);
                                ...
                                $cek2 = mysql_query("SELECT * FROM regist_kip WHERE email='$email'");
                                $ceknomor = mysql_query("SELECT * FROM regist WHERE nomor='$nomor'");
                                   if (mysql_num_rows($cek) > 0){
                                       echo "<script>alert('email telah terdaftar !!'); location.href='daftar-kip.php';</script>";
                                       exit;
                                   }elseif(mysql_num_rows($cek2) > 0){
                                       echo "<script>alert('email telah terdaftar !!'); location.href='daftar-kip.php';</script>";
                                       exit;
                                   }elseif(mysql_num_rows($ceknomor) > 0){
                                       echo "<script>alert('nomor telah terdaftar !!'); location.href='daftar-kip.php';</script>";
                                       exit;
                                   } else {
                                $simpan = mysql_query("insert into regist_kip (nama,kodelogin,email,nomor,prodi1,prodi2,prodi3,prodi4,
                                informasi,provinsi,kota,statusdaftar,usia,tahun,statusaktif,angkatan_id,periode) values (
                                '$fixnama',
                                '$password',
                                '$fixemail',
                                '$nomor',
                                ...
                                $body .='<html>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <h4 align="center">
                                            Silahkan login menggunakan email dan kode login diatas. klik disini <a href="https://pmb.undaris.ac.id/kip/login.php">https://pmb.undaris.ac.id/kip/login.php</a><br>
                                            <h3 align="center">
                                ...
                                $mail->MsgHTML("$body");
                                if($mail->Send()) echo "Message has been sent, cek email anda.";
                                else echo "Failed to sending message";
                							if ($simpan){
                                                header("location:$url/kip/login.php");
                                            }else{
                                            	echo "Gagal Simpan";
                                            }
                  }
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<meta name="description" content="PMB-UNDARIS-Penerimaan-Mahasiswa-Baru-UNDARIS-Ungaran-KIP">
	<meta name="author" content="instagram.com/fahri_atmaja">
	<title>Penerimaan Mahasiswa Baru KIP UNDARIS</title>
...
{
 <!-- handle event combobox kategori ketika nilainya di ganti -->
 $("#combokonsentrasi2").change(function() {
  <!-- mendapatkan value dari combobox -->
  var idkategori = $(this).val();
  if (idkategori != "")
  {
 ...
 $("#comboangkatan").change(function() {
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
					...
					<li class="c3"><a href="pendaftaran.php"><span class="fa fa-pencil"></span> Pendaftaran</a>
					<a href="daftar-kip.php"><span class="fa fa-pencil"></span> Pendaftaran KIP</a></li>
				
					<li class="c7">
					    <a href="calonmahasiswa"><span class="fa fa-lock"></span> Login</a>
					    <a href="kip"><span class="fa fa-lock"></span> Login KIP</a>
    ...
    <div class="row">
					...
					<div class="col-md-12">
						<div class="grey-box-icon b4">  
							 <h4 class="modal-title" id="myModalLabel">Registrasi Calon Mahasiswa UNDARIS<BR>K I P</h4>
      ...
      <div class="modal-body">
        ...
        <table class="table " width="100%">
          <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="nama" name="nama" placeholder="Nama" class="form-control" type="text" maxlength="55" required><br>
                *) Gunakan huruf kapital dengan benar dan jangan di singkat. Contoh : Fittera Aulia Finuril Ulla
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    *) Tidak perlu menggunakan angka 0 diawal. Contoh : 8132837xxxx
                </td>
            </tr>
            <tr>
            <th width="25%">Email</th>
            <td width="1%"> : </td>
            <td> <input id="email" name="email" placeholder="Masukan Email Anda" class="form-control" type="email" maxlength="55" required><br>
          ...
          <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="password" name="password" placeholder="Buat Password Login Anda" class="form-control" type="password" minlength="5" maxlength="25" required><br>
                *) Isikan password minimal 5 karakter untuk login.
                </td>
            </tr>
            <tr>
            <th width="25%">Prodi Pilihan Pertama</th>
            <td width="1%"> : </td>
               <td><select  name="prodi1" id="combokonsentrasi" class="form-control" required>
            	<option value="">-- pilih prodi utama --</option>
              <?php
                $exec=mysql_query("select * from akademik_prodi");
                while($hasil=mysql_fetch_array($exec))
                  echo "<option value='$hasil[0]'>$hasil[1]</option>";
              ?>
            </select><br>
                *) Pilih prodi utama.</td>
          </tr>
          <tr>
            <th width="25%">Pilihan</th>
            <td width="1%"> : </td>
               <td><select  name="prodi2" id="subkonsentrasi" class="form-control" required>
            	<option select="selected">-- pilihan --</option>
            </select></td>
          </tr>
          <tr>
            <th width="25%">Prodi Pilihan Kedua</th>
            <td width="1%"> : </td>
               <td><select  name="prodi3" id="combokonsentrasi2" class="form-control" required>
              ...
              ?>
                ...
                *) Pilih prodi alternatif.</td>
          </tr>
          <tr>
            <th width="25%">Pilihan</th>
            <td width="1%"> : </td>
               <td><select  name="prodi4" id="subkonsentrasi2" class="form-control" required>
            	<option select="selected">-- pilihan --</option>
            </select></td>
          </tr>
          <!-- update angkatan -->
          <tr>
            ...
            <td width="1%"> : </td>
              ...
              <?php
                $exec=mysql_query("select * from student_angkatan where angkatan_id='47'");
                while($hasil=mysql_fetch_array($exec))
                  echo "<option value='$hasil[0]'>$hasil[1]</option>";
              ?>
            </select></td>
          ...
          <tr>
            ...
            <tr>
                ...
                <td width="1%"> : </td>
                <td><input type="text" id="periode" name="periode" value="KIP 1" class="form-control" type="number" maxlength="2" required readonly></td>
            </tr>
            <input type="hidden" name="statusdaftar" id="statusdaftar" value="0">
        ...
        *) Sesudah anda mengisi semua form dengan benar anda di terima dalam tahap seleksi <br>
  ...
  <div class="footerbottom">
    ...
    <div class="col-md-12 col-sm-7"> 
            ...
            <center><i class="fa fa-phone">Klik Nomor Disini --></i><a href="https://wa.me/087717793816" target="_BLANK" style="color:black">0877-1779-3816</a> (SMS/WA) <br></center>
