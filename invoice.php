...
$load = mysql_query("SELECT * FROM proses_transaksi WHERE custCode='$custCode'");
    ...
    <div class="ui segment">
      ...
      <table class="ui collapsing table celled selectable teal">
        <tbody>
          ...
          <tr>
            <td><div class="ui ribbon label teal">Status</div></td>
            <td><?php if($view['status']=='y'){ echo "LUNAS"; }else{ echo "Belum Lunas"; } ?> </td>
          </tr>
        </tbody>
      </table>
